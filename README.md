...
from the UI: a migration history page at `/apps/groovyconsole/migrations.html` (also linked from the AEM Tools
console) and a Migrations drawer in the modern console.
